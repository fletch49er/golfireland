...
<div id="wrapper" class="clearfix">
	<div id="header">
		<img id="hdr-img" src="<?php echo IMG_URL2; ?>logos/gib-logo_green.png" alt="gib-logo_green.png" />
	</div><!-- end #header -->
...
get_template_part('templates/course-profile_data_form');
  ...
  elseif ($valid == true) :
    ...
    endforeach;
  	...
  	$from = 'golfireland.biz';
  	$subject = 'IRISH COURSE PROFILE: '.$formData['name'].'';
      ...
      echo '<p><b>Return to <a href="https://www.golfireland.biz">golfireland.biz</a> homepage</b></p>'.PHP_EOL;
  	}	else {

...
include_once('php/gi_functions.php');
?>
<!DOCTYPE html>
...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/gi-styles.css" />
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/gi-footer.css" />

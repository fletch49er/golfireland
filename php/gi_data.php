...
define ('NAME', 'golfireland.biz');
define ('WEBSITE', 'https://www.golfireland.biz');
define ('EMAIL', 'info@golfireland.biz');
define ('VATNO', '349&nbsp;9373&nbsp;46');
define ('PUB_DATE', '01/03/2021');

//Google Keys
// Analytics Key
define ('ANALYTIC_KEY', 'G-Q3S5LJWX00');
// Google Maps API Key
define ('MAP_KEY', 'AIzaSyA4eRS5f9F7QhH_sbpkNfjNX51yPBRYByM');

// navbar seperator
define('SEPERATOR', '|');

// url constants
define ('SITE_URL', 'https://www.golfireland.biz/course/');
define ('IMG_URL', 'https://www.golfireland.biz/wp-content/uploads/');
define ('IMG_URL2', 'https://www.golfireland.biz/wp-content/themes/myhome/images/');

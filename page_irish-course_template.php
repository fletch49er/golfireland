<?php
/**
 * Template Name: Irish Course Profile Page
 */
// set golf course id
if (isset($_GET)) :
...
// data queries gi_courses table - videos
$videos = $wpdb->get_results("SELECT id, video1, video2, video3 FROM gi_courses WHERE id = ".$golfCourseID."");
		...
		<script>
			...
			function initMap() {
				...
				var infoString = '<div id="gs-mapInfo">'+
      			...
      			'<div id="gs-bodyInfo">'+
      			'Par: <b class="gs-green"><?php echo $course->par; ?></b><br />' +
      			'Length: <b class="gs-green"><?php echo number_format($course->length); ?></b> yrds<br />' +
      			'Type: <b class="gs-green"><?php echo $course->type; ?></b><br />' +
      			'Region: <b class="gs-green"><?php echo $course->region; ?></b>' +
      			'</div>'+
      			'</div>';
